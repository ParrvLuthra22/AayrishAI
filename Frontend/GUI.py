...
def QueryModifier(Query):
    ...
    question_words = ["how", "what", "where", "who", "where", "when", "why", "which", "whose", "whom", "can you", "what's", "where's", "how's"]
...
def GraphicsDirectoryPath(filename):
    path = os.path.join(os.path.dirname(__file__), "Graphics", filename)
